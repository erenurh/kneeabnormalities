...
LR = 1e-4
SIZE = 320
N_SLICES = 15  # 6-slot cache has 16 -> use 15 -> 5 triplets per slot
N_SLOTS = 6
SEED = 42
...
class KneeDS(Dataset):
    ...
    def __getitem__(self, i):
        ...
        vol, mask = z["vol"][:, :N_SLICES], z["mask"]  # cache (6,16,S,S) -> first 15
...
def main():
    ...
    for ep in range(EPOCHS):
        ...
        torch.save(net.state_dict(), "/kaggle/working/effv2s_v3s6_all.pt")
