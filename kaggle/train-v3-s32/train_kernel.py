...
LR = 1e-4
SIZE = 320
N_SLICES = 30  # 32-slice cache -> use 30 -> 10 triplets per slot
N_SLOTS = 4
SEED = 42
...
class KneeDS(Dataset):
    ...
    def __getitem__(self, i):
        ...
        vol, mask = z["vol"][:, :N_SLICES], z["mask"]  # cache (4,32,S,S) -> first 30
...
def main():
    ...
    for ep in range(EPOCHS):
        ...
        torch.save(net.state_dict(), "/kaggle/working/effv2s_v3_s32_all.pt")
