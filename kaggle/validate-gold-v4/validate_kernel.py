"""Two-tier validation, tier 2: gold-58 anchor for the v4 DINOv2-S checkpoint (train-v4-dino);
v3 band to compare: 0.922-0.928. Internet ON only to fetch the HF config
(weights are overwritten by the checkpoint).
...
CKPT = sorted(INPUT.rglob("dinov2s_v4_all.pt"))[0]
