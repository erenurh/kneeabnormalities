"""v2 architecture retrained on distill-round-3 targets (v2 5-fold OOF teacher, gold 0.9266 vs r2 0.9237). Identical to train-v2 otherwise.
...
def main():
    ...
    for ep in range(EPOCHS):
        ...
        torch.save(net.state_dict(), "/kaggle/working/effv2s_v2_r3_all.pt")
