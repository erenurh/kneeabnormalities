...
| 26 | 08-30 | v2 @ 384px relaunch: 2-step gradient accumulation (effective batch 2, matching the 320px run) + LR back to 1e-4, otherwise identical to #25 (single variable: batch-1→accum-2) | | | pending |
