...
| 23 | 08-26 | v2: 24sl x 320px x BiGRU+attention-MIL+slot-attention (combines exp-21+22; batch 2, LR 1e-4, r2 targets). Trained clean 5.06h, ep9 loss 0.4136 (best loss of any run), in-train 0.9917 — submitted, awaiting LB | | | pending |
