...
| 19 | 08-26 | Distill round 2: 5 folds retrained at 320px on r1 distill targets (per-fold OOF-vs-targets .945-.951); r2 targets = 0.5*fold-OOF + 0.5*v3c-blend → **gold-58 0.9237 vs r1's 0.9166 (+0.007, gate PASS)**. r2 student (320px, all-data, 10ep) launched on distill_targets_r2 | | | student training |
